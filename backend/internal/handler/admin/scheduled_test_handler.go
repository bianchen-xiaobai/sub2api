...
type createScheduledTestPlanRequest struct {
	...
	IncludeInHealthSamples *bool  `json:"include_in_health_samples"`
}
...
func (h *ScheduledTestHandler) Create(c *gin.Context) {
	...
	if req.IncludeInHealthSamples != nil {
		plan.IncludeInHealthSamples = *req.IncludeInHealthSamples
	}
...
func (h *ScheduledTestHandler) Update(c *gin.Context) {
	...
	if req.IncludeInHealthSamples != nil {
		existing.IncludeInHealthSamples = *req.IncludeInHealthSamples
	}
